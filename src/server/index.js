...
app.get('*', (req, res) => {
    ...
    const html = `
        ...
        <head>
            ...
            <title>${title}</title>
            <meta name="keywords" content="portfolio, software developer portfolio, hamad portfolio, hackbotone, full stack application, web application development, react application, mern application, mern stack application, portfolio design, portfolio tutorials"/>
