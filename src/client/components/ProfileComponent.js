                ...
                <div className={'dashboard-profile-div'}>
                    <div className={'dashboard-profile-img-container'}>
                        ...
                        <div className={'social-profile-container'}>
                            <a href="https://www.facebook.com/profile.php?id=100057591220600" target="_blank"><img src={facebook} className={'social-profile-icon'} /></a>
                            <a href="https://www.facebook.com/profile.php?id=100057591220600" target="_blank"><img src={twitter} className={'social-profile-icon'} /></a>
                            <a href="https://www.facebook.com/profile.php?id=100057591220600" target="_blank"><img src={linkedin} className={'social-profile-icon'} /></a>
                            <a href="https://www.facebook.com/profile.php?id=100057591220600" target="_blank"><img src={github} className={'social-profile-icon'} /></a>
                            <a href="https://www.facebook.com/profile.php?id=100057591220600" target="_blank"><img src={youtube} className={'social-profile-icon'} /></a>
                        </div>
                    </div>
                    <div className={'dashboard-profile-details-container'}>
                        <p className={'dashboard-profile-name-label'}>Hello, I'm <span className={'dashboard-profile-name'}>Hammad hassan</span></p>
                        ...
                        <p className={'dashboard-profile-deatils'}>
                            As a hobby love to make games using Unity3d game engine and to share my work with developer communities I write <a href="https://www.facebook.com/profile.php?id=100057591220600" className={'profile-details-link'} target="_blank">blogs</a> and make tutorial videos on my <a href="https://www.facebook.com/profile.php?id=100057591220600" className={'profile-details-link'} target="_blank">Youtube channel.</a>
                        </p>
                    </div>
                </div>
