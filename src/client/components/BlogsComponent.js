        ...
        return (
            <div className={'blogs-parent-contents-container'}>
                <p className={'blogs-text'}>
                    Here are some of my popular blogs posted on my site, for more blogs please follow my profile <a href="https://www.facebook.com/profile.php?id=100057591220600" className={'blogs-details-link'} target="_blank">website</a>.
                </p>
